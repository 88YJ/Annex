          ...
          <div className='Gamepage-Body'>
            <div className='Gamepage-Lists'>
              ...
              <ul>
                ...
                >
                  <div className='profilepicture' style={{ backgroundImage: `url('https://www.famousbirthdays.com/faces/marshmello-image.jpg')` }} />
            ...
            <div>
              <div className='Gamepage-News'>
                ...
                <ul>
                  <li>
                    <p>
                      Lorem ipsum dolor sit amet consectetur adipisicing elit. Sapiente magnam neque sed facere laboriosam iusto repudiandae et eius eos soluta
                      recusandae reiciendis numquam, quo dolores veritatis. Ad laborum incidunt officia.
                    </p>
              ...
              <div>
                ...
                <ul>
                  <li>
                    ...
                    <p>
                      Lorem ipsum dolor sit amet, consectetur adipisicing elit. Veritatis repellat modi perferendis impedit soluta aliquid unde ea nihil ex
                      doloribus distinctio eaque dolore, suscipit, quisquam adipisci fugiat sed fuga. Libero!
                    </p>
                  </li>
                  <li>
