...
export const style = {
    primaryHeader: `${user && user.colorScheme.primaryHeader ? user.colorScheme.primaryHeader : '#66FCF1'}`,
    ...
    primaryBackground: `${user && user.primaryBackground ? user.primaryBackground : '#000411'}`,
    secondaryBackground: `${user && user.secondaryBackground ? user.secondaryBackground : '#384d48'}`,
    tertiaryBackground: `${user && user.tertiaryBackground ? user.tertiaryBackground : '#000000'}`,
}
